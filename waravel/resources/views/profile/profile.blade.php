        ...
        <div style="min-height: 600px" class="flex-shrink-0 w-auto bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6">
            ...
            <div class="text-center mt-6">
                <a href="{{ route('profile.edit', $cliente->guid) }}"
                   class="px-6 py-3 rounded-lg text-gray-800 bg-[#BFF205] hover:bg-[#A0D500]
       focus:outline-none focus:ring-2 focus:ring-[#A0D500] transition duration-300">
                    <b>Editar perfil</b>
                </a>
            </div>
        </div>
                    ...
                    @isset($productos)
                        @forelse ($productos as $producto)
                            <li class="p-4 border-b border-gray-300 dark:border-gray-700 flex items-center justify-between gap-4">
                                ...
                                <a href="" class="bg-[#BFF205] text-gray-800 font-semibold py-2 px-4 rounded-md hover:bg-[#A0D500] transition duration-300 transform hover:scale-105 flex items-center gap-2">
