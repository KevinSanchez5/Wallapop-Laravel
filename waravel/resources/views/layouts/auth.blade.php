...
@section('content')
    <div class="flex min-h-screen" style="margin-top: -24px">
        ...
        <div class="w-1/2 flex items-center justify-center bg-white dark:bg-gray-900 p-10 relative">
            <a href="{{ route('inicio') }}" class="absolute top-4 right-4 bg-gray-200 dark:bg-gray-700 p-2 rounded-full shadow-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition">
